...
(function() {
  var id = 0;
  SmarthomeObject.prototype.uniqueId = function() {
...
SmarthomeObject.prototype.toString = function() {
  return this.constructor.name+"["+this.uniqueId()+"]";
}
...
SmarthomeDevice.prototype.parseValue = function(value) {
  ...
  self.value = newValue;
  //console.log("changed " + self + " from " + oldValue + " to " + newValue );
...
SmarthomeSensor.create = function(id, name, data, home) {
  ...
  //console.log("Created " + sensor + " " + sensor.name + " of type " + sensor.type );
  return sensor;
}
...
SmarthomeActuator.create = function(id, name, data, home) {
  ...
  //console.log("Created " + act + " " + act.name + " of type " + act.type );
  return act;
}
